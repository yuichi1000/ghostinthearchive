...
const dict: Dictionary = {
  ...
  disclosure: {
    ...
    footer: {
      verified: "Bronnen geverifieerd",
      crossReferenced: "Kruisverwijzingen gecontroleerd",
  ...
  about: {
    ...
    storytellers: {
      heading: "Onze Vertellers",
      intro:
        "Elk artikel in dit archief is geschreven door een ander AI-taalmodel — onze vertellers. Verschillende modellen brengen verschillende analytische perspectieven op hetzelfde archiefmateriaal.",
    },
  },
  detail: {
    returnToArchive: "Terug naar archief",
    archivalData: "Archiefgegevens",
    archivalEvidence: "Archiefbewijs",
    primarySource: "Primaire bron",
    contrastingSource: "Contrasterende bron",
    additionalEvidence: "Aanvullend bewijs",
    published: "Gepubliceerd:",
    discoveredDiscrepancy: "Ontdekte discrepantie",
    hypothesis: "Hypothese",
    alternativeHypotheses: "Alternatieve hypothesen:",
    historicalContext: "Historische context",
    relatedEvents: "Gerelateerde gebeurtenissen:",
    keyFigures: "Sleutelfiguren:",
