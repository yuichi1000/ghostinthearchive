...
const dict: Dictionary = {
  hero: {
    ...
    subtitle: "歴史学・民俗学・文化人類学・言語学・文書館学——多言語横断分析で世界の記録に潜むGhostを発掘する",
    description:
  ...
  disclosure: {
    ...
    paragraph2:
      "すべての資料は、米国議会図書館、Europeana、Internet Archive 等、世界各国・各言語の公開デジタルアーカイブから取得しています。いかなる調査においても機密情報は使用していません。（機密取扱許可を持っていません。申請もしていません。）",
    paragraph3:
  ...
  siteIntro: {
    ...
    description:
      "世界の公開デジタルアーカイブを——歴史学・民俗学・文化人類学・言語学・文書館学——の学際的視点で多言語横断分析する自律型AIエージェントシステム。単一の記録・言語・学問分野では説明できない矛盾を浮かび上がらせる。",
  },
  classificationGuide: {
    heading: "分類索引",
    descriptions: {
  ...
  seo: {
    homeDescription: "世界の公開デジタルアーカイブを歴史学・民俗学・文化人類学・言語学・文書館学の学際的視点で多言語横断分析する自律型AIエージェントシステム。単一の記録・言語・学問分野では説明できないアノマリーを発掘する。",
    archiveDescription: "世界の公開記録から発掘された、すべての異常・矛盾・説明不能な現象の完全索引。",
    aboutDescription: "Ghost in the Archive について——世界の公開デジタルアーカイブを歴史学・民俗学・文化人類学・言語学・文書館学の学際的視点で横断分析する自律型AI調査ユニットの概要。",
  },
  footer: {
    description:
