...
export function Footer({ labels }: FooterProps) {
  ...
  const technicalDescription = labels?.technicalDescription ?? "Discoveries generated by AI agents analyzing digitized archival records. All source citations link to original documents where available."
