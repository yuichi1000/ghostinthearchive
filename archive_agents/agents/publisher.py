...
- {collected_documents}: Raw search metadata collected by the Librarian
...
**Important: The `raw_data` field should contain {collected_documents} verbatim.**
This is the raw search metadata collected by the Librarian. Save it as-is for future analysis (RAG, etc.).
